...
import { FincaListItem, useFincas, useHardwareBack, type Finca } from '@/features/fincas';
...
export default function Fincas() {
  ...
  const { data: fincas, isLoading, isError, refetch, isRefetching } = useFincas();
        ...
        <View className='flex-1 pt-4'>
          ...
          >
            <FlashList
              ...
              onRefresh={refetch}
              renderItem={({ item }) => <FincaListItem finca={item} onPress={() => handleFincaPress(item)} />}
            />
          </AsyncBoundary>
        </View>
      </Layout>
